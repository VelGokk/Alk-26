...
1) Crear proyecto en Vercel
   ...
   - Framework: Next.js (detectar automatico).
...
3) Variables de entorno obligatorias (Vercel)
   ...
   - `NEXTAUTH_URL` (URL de produccion, ej: https://alkaya.vercel.app)
   - `NEXT_PUBLIC_APP_URL` (igual a `NEXTAUTH_URL`)

4) Variables opcionales (si queres activar integraciones)
