...
async function main() {
  ...
  if (instructor) {
    const course = await prisma.course.upsert({
      ...
      create: {
        ...
        description:
          "Programa intensivo para líderes que necesitan alinear visión, equipo y resultados.",
        price: 45000,
    ...
    const draftCourse = await prisma.course.upsert({
      ...
      create: {
        ...
        description:
          "Sistema de hábitos y frameworks para equipos que necesitan foco.",
        price: 32000,
    ...
    if (!moduleExists) {
      ...
      await prisma.lesson.createMany({
        data: [
          {
            moduleId: module.id,
            title: "Visión y narrativa",
            content: "Cómo alinear equipos con una visión poderosa.",
          },
          {
            moduleId: module.id,
            title: "Rituales de gestión",
            content: "Cadencias y hábitos para mejorar performance.",
          },
        ],
      });
    }
  ...
  await prisma.blogPost.upsert({
    ...
    create: {
      ...
      excerpt: "Por qué creamos una suite LMS premium.",
  ...
  await prisma.systemSetting.upsert({
    ...
    create: {
      ...
      maintenanceMessage: "Estamos realizando mejoras. Volvé en unos minutos.",
    },
  });
  ...
  if (!comment) {
    ...
    if (user && course) {
      const created = await prisma.comment.create({
        data: {
          content: "Comentario de prueba para moderación.",
          userId: user.id,
          courseId: course.id,
        },
      });
